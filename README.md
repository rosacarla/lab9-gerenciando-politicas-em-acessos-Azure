...
<p align='justify'>- A solução de privacidade Microsoft Priva ajuda no regulatório, trabalha em parceria com o Purview (faz
 compliance. É aplicável na situação de adequação de uma empresa à LGPD no Brasil, indicando onde falta enquadramento. </p>   
